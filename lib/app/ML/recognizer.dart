...
class Recognizer {
  ...
  @override
  String get modelName => 'facenet.tflite'; //! altera a forma aqui de validação dentro da pasta assets tem os dois modelos
  ...
  TensorImage _preProcess() {
    ...
    return ImageProcessorBuilder()
        ...
        .add(ResizeOp(
        _inputShape[1], _inputShape[2], ResizeMethod.nearestneighbour)) //mudei aqui ver se esta certo
  ...
  findNearest(List<double> emb){
    Pair pair = Pair("Não identificado!!", -5);
